...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("flatpak run com.artemchep.keyguard"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(ipc .. " session lock"))
...
hl.bind("ALT + 0", hl.dsp.exec_cmd(ipc .. " volume-up 1"), { repeating = true })
hl.bind("ALT + 9", hl.dsp.exec_cmd(ipc .. " volume-down 1"), { repeating = true })
hl.bind("ALT + 8", hl.dsp.exec_cmd(ipc .. " volume-mute"), { repeating = true })
...
-- Media keys
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(ipc .. " volume-up 1"))
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(ipc .. " volume-down 1"))
