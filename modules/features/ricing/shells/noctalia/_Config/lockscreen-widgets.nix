{ pkgs, config, lib, ... }:
{
  programs.noctalia.settings = {
    lockscreen_widgets = {
      enabled = true;
      schema_version = 2;
      widget_order = [ "lockscreen-login-box@1" "lockscreen-login-box@WL-1" "lockscreen-login-box@HEADLESS-5" "lockscreen-login-box@HEADLESS-4" "lockscreen-login-box@HEADLESS-2" "lockscreen-login-box@HEADLESS-1" "lockscreen-widget-0000000000000003" "lockscreen-login-box@HDMI-A-1" "lockscreen-login-box@eDP-1" "lockscreen-login-box@HEADLESS-3" "lockscreen-login-box@sunshine" "lockscreen-login-box@DP-3" "lockscreen-widget-0000000000000001" "lockscreen-widget-0000000000000002" "lockscreen-widget-000000000000000e" ];
      grid = {
        cell_size = 16;
        major_interval = 4;
        visible = true;
      ...
      widget = {
        ...
        "lockscreen-login-box@HEADLESS-5" = {
          box_height = 196.0;
          box_width = 810.0;
          cx = 960.0;
          cy = 898.0;
        ...
        "lockscreen-login-box@WL-1" = {
          ...
          enabled = true;
          output = "WL-1";
          placement_height = 1076.0;
          placement_width = 1404.0;
          rotation = 0.0;
          type = "login_box";
          settings = {
            background_color = "surface_variant";
