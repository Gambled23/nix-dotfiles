{
  programs.plasma = {
    ...
    configFile = {
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.110.Applets.114.Configuration"."PreloadWeight" = 60;
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.110.General"."AppletOrder" = 114;
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.47.General"."AppletOrder" = "72;48";
