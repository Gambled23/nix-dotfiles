{
  programs.plasma = {
    ...
    configFile = {
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.115"."ItemGeometriesHorizontal" = "Applet-142:800,16,304,304,0;";
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.166.Applets.180.Configuration"."PreloadWeight" = 10;
