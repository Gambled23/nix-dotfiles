{
  programs.plasma = {
    ...
    configFile = {
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.115.Applets.203.Configuration.Sensors"."highPrioritySensorIds" = "[\"gpu/all/usage\"]";
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.115.Applets.203.Configuration.Sensors"."lowPrioritySensorIds" = "[\"gpu/all/usage\",\"gpu/gpu0/temperature\",\"gpu/all/totalVram\",\"gpu/all/usedVram\"]";
      "plasma-org.kde.plasma.desktop-appletsrc"."Containments.115.Applets.203.Configuration.Sensors"."totalSensors" = "[\"cpu/all/usage\"]";
