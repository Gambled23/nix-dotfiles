{
  programs.plasma = {
    ...
    configFile = {
      ...
      "plasma-org.kde.plasma.desktop-appletsrc"."ScreenMapping"."screenMapping" = "desktop:/ Captain Toad Treasure Tracker.desktop,1,1a14c463-8315-4099-a025-c3272507cfc2";
