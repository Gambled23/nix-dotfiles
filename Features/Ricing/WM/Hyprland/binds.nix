...
{ ... }: {
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    binde = [
      # Media controller
      "ALT, 0, exec, pamixer -i 1 && paplay /etc/nixos/Features/Ricing/WM/Hyprland/volume.mp3"
      "ALT, 9, exec, pamixer -d 1 && paplay /etc/nixos/Features/Ricing/WM/Hyprland/volume.mp3"
