{ config, pkgs, lib, inputs, outputs, ... }:
{
  ...
  nix = {
    settings = {
      ...
      extra-substituters = ["https://walker.cachix.org" "https://walker-git.cachix.org" "https://vicinae.cachix.org"];
      extra-trusted-public-keys = ["walker.cachix.org-1:fG8q+uAaMqhsMxWjwvk0IMb4mFPFLqHjuvfwQxE4oJM=" "walker-git.cachix.org-1:vmC0ocfPWh0S/vRAQGtChuiZBTAe4wiKDeyyXM0/7pM=" "vicinae.cachix.org-1:1kDrfienkGHPYbkpNj1mWTr7Fm1+zcenzgTizIcI3oc="];
    };
    gc = {
      automatic = true;
      dates = "weekly";
  ...
  users.users = {
    gambled = {
      ...
      extraGroups = [ "networkmanager" "wheel" "adbusers" "audio" "jackaudio" "dialout" ];
    };
  };
